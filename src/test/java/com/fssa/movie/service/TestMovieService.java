...
public class TestMovieService {
	...
	public static Movie addNewMovies() {
		Movie data=new Movie("kushi",MovieLanguage.TAMIL,MovieFormat.FORMAT_2D,MovieCertificate.UNIVERSAL,MovieGenre.ROMANCE,2,53,10,"A couple who are predicted to have a failed marriage, decide to become ideal partners for each other. Will it work out or will they realize that their parents were right?",LocalDate.of(2023, 9, 7),"https://timesofindia.indiatimes.com/photo/91608543.cms","https://static.zoomnews.com/photo/msid-103299067/103299067.jpg",MovieStatus.CURRENTLY_RUNNING);
		
		return data;
	}
	public static Movie updateMovies() {
		Movie data=new Movie(19,"Captain Miller",MovieLanguage.ENGLISH,MovieFormat.FORMAT_2D,MovieCertificate.UNIVERSAL_ADULT,MovieGenre.ACTION,2,55,10,"Captain Miller is a Tamil movie starring Dhanush in a prominent role. It is written and directed by Arun Matheswaran."
    ...
    @Test
    	  void testDeleteMovieServiceLayer() throws DAOExceptions, MovieValidateException, SQLException{
   		Assertions.assertTrue(MovieService.deleteMovie(25));
     	  }
